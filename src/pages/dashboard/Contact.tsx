        ...
        <div className="flex flex-col min-h-screen">
            ...
            <div className="bg-teal-500 text-white py-16 text-center">
                <div className="max-w-4xl mx-auto px-4">
                    <h1 className="text-3xl font-bold mb-2">Hãy để đội ngũ tư vấn của Green Home hỗ trợ bạn</h1>
            ...
            <div className="max-w-7xl mx-auto px-4 py-8 grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 bg-white rounded shadow">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3918.214594705107!2d106.78918677485835!3d10.871276389283283!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3175276398969f7b%3A0x9672b7efd0893fc4!2zVHLGsOG7nW5nIMSQ4bqhaSBo4buNYyBOw7RuZyBMw6JtIFRQLiBI4buTIENow60gTWluaA!5e0!3m2!1svi!2s!4v1746754955505!5m2!1svi!2s"
                        width="100%"
                        height="500"
                        title="GreenHome Locations Map"
                        className="border-0"
                    ></iframe>
                </div>
                ...
                <div className="lg:col-span-1">
                    <div className="bg-white rounded shadow p-6">
                        <h2 className="text-lg font-medium text-blue-600 mb-4">Hệ thống văn phòng và chi nhánh của Sapo
                            trên toàn quốc</h2>
                        ...
                        <div className="mb-6">
                            ...
                            <p className="text-sm text-gray-600 mb-2">Công ty CP Công nghệ Sapo Tầng 6 - 244 Đội Cấn,
                                phường Liễu Giai, Quận Ba Đình, TP Hà Nội</p>
                        </div>
                        ...
                        <div className="mb-6">
                            ...
                            <ul className="text-sm text-gray-600 space-y-2">
                                ...
                                <li>• 73G, 16-A9, Đường Xuân Hòa, Phường Phúc Diễn Phường, Thành phố Thái Nguyên, Tỉnh
                                    Thái Nguyên
                                </li>
            ...
            <div className="max-w-4xl mx-auto px-4 py-12 text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <p className="font-medium mb-2">support@greenhome.vn</p>
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <p className="font-medium mb-2">www.support.greenhome.vn</p>
