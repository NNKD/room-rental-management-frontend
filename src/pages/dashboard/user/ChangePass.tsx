...
export default function ChangePass() {
    ...
    const handleUpdatePass = async () => {
        try {
            const response = await axios.put(
                `${envVar.API_URL}/dashboard-user/me/account/update-pass`,
                {
                    pass,
                    newPass,
                },
    ...
    return (
        <div className="text-left">
            ...
            <div
                className="mx-auto mt-8 bg-lightGreen w-fit px-10 py-2 rounded font-bold cursor-pointer shadow-[0_0_2px_1px_#ccc] hover:bg-lightGreenHover transition-all duration-300 ease-in-out"
                onClick={() => handleSave()}
            >
                {t("save")}
            </div>
